return {
	...
	-- Add this to your colorscheme file alongside your other themes
	...
	-- NOTE: Catppuccin
	{
		...
		config = function()
			require("catppuccin").setup({
				...
				custom_highlights = function(colors)
					return {
						...
						TelescopePromptBorder = { fg = colors.blue, bg = colors.none },
						TelescopePromptTitle = { fg = colors.pink, bg = colors.none },
						TelescopePreviewTitle = { fg = colors.green, bg = colors.none },
						TelescopeResultsTitle = { fg = colors.lavender, bg = colors.none },
			...
			-- Setup the colorscheme here if you want it as default
	...
	--NOTE: Nightfox
	{
		...
		config = function()
			...
			-- Available: nightfox, dayfox, dawnfox, duskfox, nordfox, terafox, carbonfox
		end,
	},
}
